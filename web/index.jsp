...
<div id="top">
    <div id="navtop">
        ...
        <div class="ntright">
            <a href="#">登录</a> | <a href="#">注册</a> | <a href="#">消息通知</a>  <div><a href="/xaiomi/shopcart.jsp">购物车 (0)</a></div>
        </div>
    </div>
</div>
<header>
    ...
    $(function() {
        $.ajax({
            ...
            success: function (response) {
                ...
                // 获取一级类型
               /*
               * <div class = "goodsboxitem"></div>
               **/
                let $goodsTypes = response.objectMap.topLevel;
                ...
                <a href="#">
                    <div class="content">
                        ...
                        <div class="title">米家</div>
                        <div class="desc">超博机身</div>
                        <div class="price">
                            <span>1229</span>
                            <del>1235</del>
                        </div>
        ...
        $('#search button').click(function () {
            ...
            console.log($word);
            // 页面跳转
            window.location = "/xaiomi/goodslist.jsp?wd="+$word;
            window.event.returnValue = false;
        });

        // js脚本加载的元素是未来元素，普通事件操作会失效
        $('#bannel-type > ul').on("click","li",function () {
            // 获取商品类型编号
            let $goodsTypeId = $(this).prop("id");
            // 点击主页左边的商品分类菜单  就是一级商品
            // 点击效果是展示商品详情页面
            window.location = "/xaiomi/goodslist2.jsp?level=1&goodsTypeId=" + $goodsTypeId;
        });
    });
</script>
</body>
